...
hash_init(&thread_current()->spt_hash_table, spt_hash, spt_hash_less, NULL);
  ...
  while (read_bytes > 0 || zero_bytes > 0) 
    {
      ...
      uint8_t *kpage;
      kpage=frame_allocator(PAL_USER);
